...
class ContextActionAdd : public ::google::protobuf::Message {
 public:
  ...
  inline ContextActionAdd* New() const { return New(NULL); }

  ContextActionAdd* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(ContextActionAdd* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
...
inline void ContextActionAdd::set_allocated_action(::std::string* action) {
  if (action != NULL) {
    set_has_action();
  } else {
    clear_has_action();
...
inline void ContextActionAdd::set_allocated_text(::std::string* text) {
  if (text != NULL) {
    set_has_text();
  } else {
    clear_has_text();
...
template <> struct is_proto_enum< ::MumbleProto::ContextActionAdd_Context> : ::google::protobuf::internal::true_type {};
template <>
